import baguaData from '../knowledge/bagua.json';
import hexagramsData from '../knowledge/hexagrams.json';
import linesData from '../knowledge/lines.json';
import correspondencesData from '../knowledge/correspondences.json';
import interpretationRules from '../knowledge/interpretation_rules.json';
